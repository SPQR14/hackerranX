...
"""
########################################################################################################################
                                            arrays de numpy/índice de masa corporal.
########################################################################################################################
"""
...
arreglo_especial = np.array([1, 2, 3, 4 ,5, 6, 7, 100], dtype='i')
...
imc = pesos / (alturas ** 2)
t1 = perf_counter()
print(f'se determinaron los siguientes índices de IMC {imc} en {t1 - t0}')

print('la media', imc.mean())
...
t1 = perf_counter()
print(f'se determinaron los siguientes índices de IMC as list {imc} en {t1 - t0}')
